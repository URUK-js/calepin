...
function getBrowserRTC() {
  ...
  const wrtc = {
    ...
    RTCSessionDescription:
      globalThis.RTCSessionDescription || globalThis.mozRTCSessionDescription || globalThis.webkitRTCSessionDescription,
    ...
    const findCandidatePair = () => {
      ...
      this.getStats((err, items) => {
        ...
        const setSelectedCandidatePair = (selectedCandidatePair) => {
          ...
          console.loog("setSelectedCandidatePair");
...
console.log("support: ", Peer.WEBRTC_SUPPORT);
/**
